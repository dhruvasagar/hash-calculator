...
public class HashCalculator extends JFrame {
	...
	private void setTray()
	{
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae)
			{
				...
				if(!isTray||trayMenu.isIconVisible() )
					trayMenu.hideIcon();
				else
					trayMenu.showIcon();
				dialog.dispose();
	...
	/**
	 * Method to set the System Tray Menu.
	 * created : Dec 5, 2006 11:57:14 AM
	 */
	...
	private static void showSplash(final HashCalculator hc)
	{
		...
		//splashWin.setLocation((int)(Toolkit.getDefaultToolkit().getScreenSize().getWidth()-splash.getWidth())/2,(int)(Toolkit.getDefaultToolkit().getScreenSize().getHeight()-splash.getHeight())/2);
